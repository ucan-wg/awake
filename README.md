...
The [ECDH handshake step][ECDH Input] MUST use [X25519].

### 2.3.2 Symmetric Keys

All symmetric encryption in AWAKE MUST use [XChaCha-Poly1305]. These keys MUST be generated by the [KDF](#143-diffie-hellman-key-derivation), and SHOULD be non-extractable where possible.
